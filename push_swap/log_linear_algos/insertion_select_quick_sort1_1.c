...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   insertion_select_quick_sort1_1.c                   :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: aazzaoui <aazzaoui@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/20 13:12:21 by aazzaoui          #+#    #+#             */
/*   Updated: 2025/02/20 13:12:22 by aazzaoui         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sort_by_mid_num7(void)
{
	...
	while (stack_a()->count > 2 && !is_rest_stack_sorted7(stack_a()->contate,
			stack_a()->count))
	{
		pb();
...
void	ins_sel_quick_sort(void)
{
	...
	{
		if (b->count > 0)
			make_move7(b->count, stack_a()->contate, b->contate);
		pa();
		if (b->count == 0)
			rotate_stack_a7();
	}
